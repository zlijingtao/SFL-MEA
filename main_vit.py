...
parser.add_argument('--cutlayer', default=10, type=int, help='number of layers in local')
parser.add_argument('--num_freeze_layer', default=9, type=int, help='number of layers to freeze completely')
