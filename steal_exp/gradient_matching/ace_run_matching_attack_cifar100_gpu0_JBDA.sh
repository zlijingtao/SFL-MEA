...
attack_client=0
num_query=10
attack_style="gradient_matching_JBDA_option_B"
                        ...
                        for num_client in $num_client_list; do
                                for local_lr in $local_lr_list; do
                                        for data_proportion in $data_proportion_list; do
                                                ...
                                                filename=ace_V2_epoch_vgg11_bn_cutlayer_4_client_1_seed125_dataset_${dataset}_lr_0.05_None_both_custom_0.0_200epoch_bottleneck_None
