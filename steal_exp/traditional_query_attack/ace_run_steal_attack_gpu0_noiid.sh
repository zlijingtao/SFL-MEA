...
folder_name="poison_saves/baseline"
...
attack_client=0
num_query=10
attack_style="JBDA_option_A"
# data_proportion_list="0.01 0.2"
# noniid_ratio_list="0.1 0.2"
                        ...
                        for num_client in $num_client_list; do
                                for noniid_ratio in $noniid_ratio_list; do
                                        for data_proportion in $data_proportion_list; do
                                                ...
                                                filename=ace_V2_epoch_vgg11_bn_cutlayer_4_client_1_seed125_dataset_cifar10_lr_0.05_None_both_custom_0.0_200epoch_bottleneck_None
                                                ...
                                                CUDA_VISIBLE_DEVICES=${GPU_id} python main_model_steal.py   --arch=${arch} --cutlayer=$cutlayer --batch_size=${batch_size} \
                                                        ...
                                                        --attack_style=$attack_style  --data_proportion=${data_proportion} --train_clas_layer=${train_clas_layer} --noniid_ratio=${noniid_ratio}
                                                done
                                        done
                                done
                        done
