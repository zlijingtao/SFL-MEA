...
regularization_list=(topkprune dropout local_dp_laplace nopeek l1 l2 gradient_noise_local gradient_noise_cloud)
regularization_strength_list=(0.75 0.5 20.0 1.0 1e-3 1e-4 0.0 0.0)
