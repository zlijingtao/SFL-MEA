...
attack_style_list="None"
data_proportion_list="0.02"
train_clas_layer_list=" 4 5 6 7 8 9"
...
#                                                 filename=ace_V2_epoch_vgg11_bn_cutlayer_4_client_1_seed125_dataset_${dataset}_lr_0.05_None_both_custom_0.0_200epoch_dataset_portion_1.0
