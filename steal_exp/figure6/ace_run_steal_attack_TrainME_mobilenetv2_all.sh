...
# dataset_list="cifar10 cifar100 svhn mnist fmnist"
dataset_list="svhn mnist fmnist"
...
#                                                 filename=ace_V2_epoch_${arch}_cutlayer_4_client_1_seed125_dataset_${dataset}_lr_0.02_200epoch
