...
bash figure4/ace_run_steal_attack_GMME_vgg11bn_cifar10_longer.sh
bash figure4/ace_run_steal_attack_GMME_vgg11bn_cifar10_shorter.sh
# bash figure4/ace_run_steal_attack_TrainME_vgg11bn_cifar10_longer.sh
# bash figure4/ace_run_steal_attack_TrainME_vgg11bn_cifar10_shorter.sh
