...
attack_epochs=50
attack_client=0
regularization_list="naive_train_ME_surrogate_print_margin_stats_start0"
cutlayer_list="10"
                                ...
                                for noniid_ratio in $noniid_ratio_list; do
                                        for regularization in $regularization_list; do
                                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                                        ...
                                                        folder_name="saves/$scheme-grad-stats"
                                                        filename="$scheme-vgg11-cifar10-$regularization-str$regularization_strength-cut$cutlayer-client$num_client-noniid$noniid_ratio--data$last_client_fix_amount"
