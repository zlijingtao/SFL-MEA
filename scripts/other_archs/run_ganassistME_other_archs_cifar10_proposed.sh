...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_propermix_start0 naive_train_ME_start0"
                                        ...
                                        for regularization in $regularization_list; do
                                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                                        for regularization_strength in $regularization_strength_list; do
                                                                ...
                                                                filename="$scheme-$arch-cifar10-$regularization-str$regularization_strength-cut$cutlayer-client$num_client-noniid$noniid_ratio--data$last_client_fix_amount--budget$attacker_querying_budget_num_step"
