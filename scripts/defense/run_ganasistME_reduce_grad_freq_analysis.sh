...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_ultramix_reduce_grad_freq_print_loss_start0 gan_assist_train_ME_multiGAN_surrogate_ultramix_print_loss_start0"
cutlayer_list="10"
