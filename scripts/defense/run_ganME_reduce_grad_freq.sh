...
attack_epochs=200
attack_client=0
# regularization_list="gan_train_ME_multiGAN_surrogate_ultramix_reduce_grad_freq_by2_start0 gan_train_ME_multiGAN_surrogate_ultramix_reduce_grad_freq_start0"
regularization_list="gan_train_ME_multiGAN_surrogate_ultramix_reduce_grad_freq_by3_start0 gan_train_ME_multiGAN_surrogate_ultramix_reduce_grad_freq_by4_start0"
cutlayer_list="10"
