...
attack_epochs=200
attack_client=0
# regularization_list="gan_train_ME_multiGAN_surrogate_propermix_reduce_grad_freq_by2_start0 gan_train_ME_multiGAN_surrogate_propermix_reduce_grad_freq_start0"
regularization_list="gan_train_ME_multiGAN_surrogate_propermix_reduce_grad_freq_by3_start0 gan_train_ME_multiGAN_surrogate_propermix_reduce_grad_freq_by4_start0"
cutlayer_list="10"
                                ...
                                for noniid_ratio in $noniid_ratio_list; do
                                        for regularization in $regularization_list; do
                                                for regularization_strength in $regularization_strength_list; do
                                                        ...
                                                        folder_name="saves/$scheme-seed$random_seed-defense"
