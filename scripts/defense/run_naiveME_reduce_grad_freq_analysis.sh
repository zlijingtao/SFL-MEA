...
attack_epochs=50
attack_client=0
# regularization_list="naive_train_ME_surrogate_print_loss_start0"
regularization_list="gan_assist_train_ME_multiGAN_surrogate_ultramix_print_loss_start0"
cutlayer_list="10"
regularization_strength_list="0.6"
num_client_list="5"
noniid_ratio_list="1.0"
last_client_fix_amount_list="10000"
