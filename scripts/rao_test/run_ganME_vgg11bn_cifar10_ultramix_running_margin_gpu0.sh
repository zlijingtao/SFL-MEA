...
attack_epochs=200
attack_client=0
regularization_list="gan_train_ME_multiGAN_surrogate_ultramix_start0 gan_train_ME_multiGAN_surrogate_variablemix_start0"
cutlayer_list="10"
regularization_strength_list="0.6 0.7 0.8"
num_client_list="5"
