...
attack_epochs=50
attack_client=0
# regularization_list="gan_assist_train_ME_multiGAN_surrogate_ultramix_start0"
regularization_list="gan_assist_train_ME_multiGAN_surrogate_ultramix_start0 gan_assist_train_ME_multiGAN_surrogate_start0 gan_assist_train_ME_surrogate_start0 naive_train_ME_surrogate_start0 naive_train_ME_start0"
cutlayer_list="10"
                                        ...
                                        for regularization in $regularization_list; do
                                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                                        for regularization_strength in $regularization_strength_list; do
                                                                ...
                                                                folder_name="saves/testAA-$scheme-seed$random_seed"
                                                                filename="$scheme-vgg11-$dataset-$regularization-str$regularization_strength-cut$cutlayer-client$num_client-noniid$noniid_ratio--data$last_client_fix_amount--budget$attacker_querying_budget_num_step"
                                                                CUDA_VISIBLE_DEVICES=$GPU_id python main_steal_online.py   --arch=$arch --cutlayer=$cutlayer --batch_size=$batch_size \
                                                                        ...
                                                                        --attacker_querying_budget_num_step=$attacker_querying_budget_num_step --adversairal_attack
                                                                done
                                                        done
                                                done
                                        done
...
attack_epochs=50
attack_client=0
regularization_list="gan_train_ME_multiGAN_surrogate_ultramix_start0 gan_train_ME_multiGAN_surrogate_start0 gan_train_ME_surrogate_start0 gan_train_ME_start0"
cutlayer_list="10"
