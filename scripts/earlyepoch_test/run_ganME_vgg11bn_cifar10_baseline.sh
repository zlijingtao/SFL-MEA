...
attack_epochs=200
attack_client=0
regularization_list="gan_train_ME_surrogate_earlyepoch0_start0 gan_train_ME_surrogate_earlyepoch50_start0 gan_train_ME_surrogate_earlyepoch100_start0 gan_train_ME_surrogate_earlyepoch150_start0"
cutlayer_list="10"
                                ...
                                for noniid_ratio in $noniid_ratio_list; do
                                        for regularization in $regularization_list; do
                                                for regularization_strength in $regularization_strength_list; do
                                                        ...
                                                        folder_name="saves/earlylearner-$scheme-seed$random_seed-schedulerfixed"
