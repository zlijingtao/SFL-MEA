...
attacker_querying_budget_num_step_list="1 2 5 10 20 50"
...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_randommix_test7_start0"
cutlayer_list="10"
regularization_strength_list="0.5 0.8"
num_client_list="5"
noniid_ratio_list="1.0"
last_client_fix_amount_list="50"
