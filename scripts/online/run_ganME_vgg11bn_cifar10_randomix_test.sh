...
attack_epochs=200
attack_client=0
regularization_list="gan_train_ME_multiGAN_surrogate_randommix_test1_start0"
cutlayer_list="10"
...
regularization_list="gan_train_ME_multiGAN_surrogate_randommix_test2_start0"
cutlayer_list="10"
regularization_strength_list="1.0 0.8 0.5"
num_client_list="5"
noniid_ratio_list="1.0"
attacker_querying_budget_num_step_list="-1"
for random_seed in $random_seed_list; do
