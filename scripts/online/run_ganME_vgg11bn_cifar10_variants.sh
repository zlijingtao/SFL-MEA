...
attack_epochs=200
attack_client=0
regularization_list="gan_train_ME_noreg_surrogate_start0 gan_train_ME_noreg_multiGAN_surrogate_start0 gan_train_ME_noreg_surrogate_adversary_start0 gan_train_ME_noreg_multiGAN_surrogate_adversary_start0"
cutlayer_list="10"
