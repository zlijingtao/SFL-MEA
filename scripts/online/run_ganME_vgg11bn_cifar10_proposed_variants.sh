...
attack_epochs=200
attack_client=0
# regularization_list="gan_train_ME_multiGAN_surrogate_randommix_test7_start0"
regularization_list="gan_train_ME_multiGAN_surrogate_randommix_test6_start0 gan_train_ME_multiGAN_surrogate_randommix_test8_start0"
# regularization_list="gan_train_ME_multiGAN_surrogate_randommix_start0"
cutlayer_list="10"
regularization_strength_list="0.5 0.4 0.3 0.2"
num_client_list="5"
