...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_surrogate_start0 gan_assist_train_ME_multiGAN_surrogate_start0 gan_assist_train_ME_multiGAN_surrogate_randommix_start0"
cutlayer_list="10"
