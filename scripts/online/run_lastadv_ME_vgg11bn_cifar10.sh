...
# regularization=naive_train_ME_advnoise_signflip_pgd_start0
regularization=naive_train_ME_advnoise_start0
# cutlayer_list="10 11 12 13"
cutlayer_list="10"
regularization_strength_list="10.0"
                        ...
                        for noniid_ratio in $noniid_ratio_list; do
                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                        for last_n_batch in $last_n_batch_list; do
                                                ...
                                                folder_name="saves/lastadv-seed$random_seed"
