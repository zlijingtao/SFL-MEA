...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_adversary_start0"
# regularization_list="gan_assist_train_ME_start0"
cutlayer_list="10"
...
attacker_querying_budget_num_step_list="10 20 50"
                                ...
                                for regularization in $regularization_list; do
                                        for last_client_fix_amount in $last_client_fix_amount_list; do
                                                for regularization_strength in $regularization_strength_list; do
                                                        ...
                                                        folder_name="saves/V1"
                                                        filename="vgg11-cifar10-$regularization-str$regularization_strength-cut$cutlayer-client$num_client-noniid$noniid_ratio--data$last_client_fix_amount--budget$attacker_querying_budget_num_step"
