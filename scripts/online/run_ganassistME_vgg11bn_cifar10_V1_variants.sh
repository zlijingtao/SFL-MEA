...
attack_epochs=50
attack_client=0
# regularization_list="gan_assist_train_ME_surrogate_start0 gan_assist_train_ME_multiGAN_surrogate_start0 gan_assist_train_ME_multiGAN_surrogate_adversary_start0"
regularization_list="gan_assist_train_ME_surrogate_start0 gan_assist_train_ME_start0"
cutlayer_list="10"
                                        ...
                                        for regularization in $regularization_list; do
                                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                                        for regularization_strength in $regularization_strength_list; do
                                                                ...
                                                                folder_name="saves/$scheme-seed$random_seed-modelpoison"
