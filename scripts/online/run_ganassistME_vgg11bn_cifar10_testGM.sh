...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_adversary_start0 gan_assist_train_ME_multiGAN_surrogate_start0 gan_assist_train_ME_multiGAN_surrogate_GM_start0"
