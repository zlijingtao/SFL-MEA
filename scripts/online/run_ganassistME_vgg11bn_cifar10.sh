...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_half_half_reverse_grad_start0 gan_assist_train_ME_half_half_diverse_reverse_grad_start0"
# regularization_list="gan_assist_train_ME_reverse_grad_start0 naive_train_ME_diffaug_reverse_grad_start0"
cutlayer_list="10"
