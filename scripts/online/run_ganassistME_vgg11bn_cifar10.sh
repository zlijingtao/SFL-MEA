...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_reverse_grad_start0"
# regularization_list="naive_train_ME_diffaug_randomnoise_start0"
# regularization_list="naive_train_ME_randomnoise_start0"
# regularization_list="gan_assist_train_ME_var_half_half_diverse_start0"
cutlayer_list="10"
