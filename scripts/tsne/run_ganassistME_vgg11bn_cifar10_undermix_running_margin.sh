...
attack_epochs=50
attack_client=0
regularization_list="gan_assist_train_ME_multiGAN_surrogate_randommix_print_margin_stats_start0"
cutlayer_list="10"
regularization_strength_list="0.2"
num_client_list="5"
                                        ...
                                        for regularization in $regularization_list; do
                                                for last_client_fix_amount in $last_client_fix_amount_list; do
                                                        for regularization_strength in $regularization_strength_list; do
                                                                ...
                                                                folder_name="saves/$scheme-featuregap"
